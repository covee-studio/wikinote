...
export function SourcesModal({ isOpen, onClose }: SourcesModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-slate-900/30 backdrop-blur-sm z-50 flex items-center justify-center p-4 fade-in"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        ref={containerRef}
        className="z-[41] p-6 rounded-2xl w-full max-w-md flex flex-col relative fade-in max-h-[85vh] overflow-y-auto"
        style={{
          background: "#ffffff",
