...
export function MountainsTheme() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #f4eee1 0%, #efe8d9 60%, #e8dfcd 100%)' }}>
      <Flock top="13%" dur={45} scale={1} count={7} />
      <Flock top="24%" dur={60} scale={0.7} count={5} />
      <svg viewBox="0 0 1200 600" preserveAspectRatio="none" className="absolute bottom-0 left-0 w-full" style={{ height: '42vh' }}>
        <path d="M0,320 C180,340 320,240 500,280 C700,330 880,220 1050,260 L1200,240 L1200,600 L0,600 Z" fill="#d1d5d1" />
        <path d="M0,420 C120,380 220,290 350,360 C480,430 580,310 720,380 C850,450 980,320 1200,390 L1200,600 L0,600 Z" fill="#b5bcba" />
        <path d="M0,480 C60,450 120,380 180,280 C230,190 280,340 360,420 C420,480 460,350 540,260 C600,170 660,320 740,410 C820,500 880,380 960,290 C1030,200 1100,340 1200,440 L1200,600 L0,600 Z" fill="#8d9796" />
      </svg>
    </div>
  )
}
...
export function MountainsPreview() {
  return (
    <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, #f4eee1 0%, #e8dfcd 100%)' }}>
      <svg viewBox="0 0 1200 600" preserveAspectRatio="none" className="absolute bottom-0 left-0 w-full" style={{ height: '64%' }}>
        <path d="M0,320 C180,340 320,240 500,280 C700,330 880,220 1050,260 L1200,240 L1200,600 L0,600 Z" fill="#d1d5d1" />
        <path d="M0,420 C120,380 220,290 350,360 C480,430 580,310 720,380 C850,450 980,320 1200,390 L1200,600 L0,600 Z" fill="#b5bcba" />
        <path d="M0,480 C60,450 120,380 180,280 C230,190 280,340 360,420 C420,480 460,350 540,260 C600,170 660,320 740,410 C820,500 880,380 960,290 C1030,200 1100,340 1200,440 L1200,600 L0,600 Z" fill="#8d9796" />
      </svg>
